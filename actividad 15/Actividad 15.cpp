//José Daniel Ramos Portillo
 00207819
 Oscar Alfredo Canas Mendez
00096819
Jonathan Alexis Cardona Garcia 
00128819
Carlos Rodrigo Lopez Lopez 
00083917
Ricardo Arturo Escobar Solano
00123619//
#include <iostream>
using namespace std;
...
int Altura(nodo *Rama){
    if(Rama==NULL)
        return -1;
    int alturaI = Altura(Rama->izq);
    int alturaD = Altura(Rama->der);
...
int main(){
    ...
    do{
        ...
        switch(opcion){
            ...
            break;
            case 3: cout << "La altura es: " << Altura(arbol) << endl;
            break;
